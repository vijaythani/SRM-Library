...
<form class="" action="connect.php" method="post">
	<div class='box'>
<b>MODIFY Library BY:</b>
&nbsp&nbsp<input type='radio' name='id' value="libraryname" class="sel">LibraryName</input>
<input type='radio' name='id' value="location" class="sel">Location</input>
<input type='radio' name='id' value="building" class="sel">Building</input><br/><br/>
<input type='radio' name='id' value="mailid" class="sel">MailId</input><br/><br/>
<input type='radio' name='id' value="phone" class="sel">Phone</input><br/><br/>
